...
{
  new (message_memory) amr_msgs::msg::PoseStamped(_init);
}

void PoseStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<amr_msgs::msg::PoseStamped *>(message_memory);
  typed_message->~PoseStamped();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember PoseStamped_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(amr_msgs::msg::PoseStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(amr_msgs::msg::PoseStamped, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(amr_msgs::msg::PoseStamped, localized),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PoseStamped_message_members = {
  ...
  3,  // number of fields
  sizeof(amr_msgs::msg::PoseStamped),
...
{
  return &::amr_msgs::msg::rosidl_typesupport_introspection_cpp::PoseStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, amr_msgs, msg, PoseStamped)() {
  return &::amr_msgs::msg::rosidl_typesupport_introspection_cpp::PoseStamped_message_type_support_handle;
}
