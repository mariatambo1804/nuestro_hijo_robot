...
bool amr_msgs__msg__range_scan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("amr_msgs.msg._range_scan.RangeScan", full_classname_dest, 34) == 0);
  }
  amr_msgs__msg__RangeScan * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of RangeScan */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("amr_msgs.msg._range_scan");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RangeScan");
