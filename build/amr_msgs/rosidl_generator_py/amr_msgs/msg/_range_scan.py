...
class Metaclass_RangeScan(type):
    """Metaclass of message 'RangeScan'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'amr_msgs.msg.RangeScan')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__range_scan
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__range_scan
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__range_scan
            cls._TYPE_SUPPORT = module.type_support_msg__msg__range_scan
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__range_scan
    ...
    def ULTRASOUND(self):
        ...
        return Metaclass_RangeScan.__constants['ULTRASOUND']

    @property
    def INFRARED(self):
        """Message constant 'INFRARED'."""
        return Metaclass_RangeScan.__constants['INFRARED']


class RangeScan(metaclass=Metaclass_RangeScan):
    """
    Message class 'RangeScan'.
