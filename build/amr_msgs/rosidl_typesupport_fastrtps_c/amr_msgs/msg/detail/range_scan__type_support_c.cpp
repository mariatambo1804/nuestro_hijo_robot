...
#include "amr_msgs/msg/detail/range_scan__rosidl_typesupport_fastrtps_c.h"
...
using _RangeScan__ros_msg_type = amr_msgs__msg__RangeScan;

static bool _RangeScan__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RangeScan__ros_msg_type * ros_message = static_cast<const _RangeScan__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _RangeScan__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _RangeScan__ros_msg_type * ros_message = static_cast<_RangeScan__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_amr_msgs__msg__RangeScan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RangeScan__ros_msg_type * ros_message = static_cast<const _RangeScan__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RangeScan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amr_msgs__msg__RangeScan(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msgs
size_t max_serialized_size_amr_msgs__msg__RangeScan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_msgs__msg__RangeScan;
    is_plain =
      (
...
static size_t _RangeScan__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_amr_msgs__msg__RangeScan(
...
static message_type_support_callbacks_t __callbacks_RangeScan = {
  "amr_msgs::msg",
  "RangeScan",
  _RangeScan__cdr_serialize,
  _RangeScan__cdr_deserialize,
  _RangeScan__get_serialized_size,
  _RangeScan__max_serialized_size
};

static rosidl_message_type_support_t _RangeScan__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RangeScan,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amr_msgs, msg, RangeScan)() {
  return &_RangeScan__type_support;
}
