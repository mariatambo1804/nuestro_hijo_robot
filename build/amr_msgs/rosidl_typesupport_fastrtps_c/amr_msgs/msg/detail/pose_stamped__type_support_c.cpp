...
#include "amr_msgs/msg/detail/pose_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _PoseStamped__ros_msg_type = amr_msgs__msg__PoseStamped;
...
size_t get_serialized_size_amr_msgs__msg__PoseStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PoseStamped__ros_msg_type * ros_message = static_cast<const _PoseStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PoseStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_amr_msgs__msg__PoseStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_amr_msgs
size_t max_serialized_size_amr_msgs__msg__PoseStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = amr_msgs__msg__PoseStamped;
    is_plain =
      (
...
static size_t _PoseStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_amr_msgs__msg__PoseStamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, amr_msgs, msg, PoseStamped)() {
