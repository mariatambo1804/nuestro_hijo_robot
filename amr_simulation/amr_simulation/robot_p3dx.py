...
class RobotP3DX(Robot):
    ...
    def move(self, v: float, w: float) -> None:
        ...
        # Obtain the left wheel and right wheel

        wl = (v - (w * self._track / 2.0)) / self._wheel_radius 
        wr = (v + (w * self._track / 2.0)) / self._wheel_radius 

        # Send angular velocities to CoppeliaSim motors 
